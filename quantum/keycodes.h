...
// Zhaqian custom keycodes
    UNDERGLOW_RGB_TOG = 0x7FA2,
    KEY_RGB_TOG = 0x7FA3,
    LOGO_RGB_TOG = 0x7FA4,
    RGB_CONTROL_SW = 0x7FA5,

    UNDERGLOW_RGB_MODE_SYNC = 0x7FA6,
    UNDERGLOW_RGB_MODE_FORWARD = 0x7FA7,
    UNDERGLOW_RGB_MODE_REVERSE = 0x7FA8,
    UNDERGLOW_RGB_HUE_INCREASE = 0x7FA9,
    UNDERGLOW_RGB_HUE_DECREASE = 0x7FAA,
    UNDERGLOW_RGB_SAT_INCREASE = 0x7FAB,
    UNDERGLOW_RGB_SAT_DECREASE = 0x7FAC,
    UNDERGLOW_RGB_VAL_INCREASE = 0x7FAD,
    UNDERGLOW_RGB_VAL_DECREASE = 0x7FAE,
    UNDERGLOW_RGB_SPEED_INCREASE = 0x7FAF,
    UNDERGLOW_RGB_SPEED_DECREASE = 0x7FB0,
    ...
    RGB_IND_TOGGLE = 0x7FB6,
    RGB_IND_MODE_FORWARD = 0x7FB7,
    RGB_IND_MODE_REVERSE = 0x7FB8,
    
    RGB_IND_NUM_LOCK_TOG = 0x7FB9,
    RGB_IND_NUM_LOCK_MF = 0x7FBA,
    RGB_IND_NUM_LOCK_MR = 0x7FBB,
    RGB_IND_CAPS_LOCK_TOG = 0x7FBC,
    RGB_IND_CAPS_LOCK_MF = 0x7FBD,
    RGB_IND_CAPS_LOCK_MR = 0x7FBE,
    RGB_IND_SCROLL_LOCK_TOG = 0x7FBF,
...
// Zhaqian custom keycodes alias
    UG_RGB_TOG = UNDERGLOW_RGB_TOG,
    K_RGB_TOG  = KEY_RGB_TOG,
    L_RGB_TOG  = LOGO_RGB_TOG,
    RGB_CT_SW  = RGB_CONTROL_SW,
    UG_RGB_MS  = UNDERGLOW_RGB_MODE_SYNC,
    UG_RGB_MF  = UNDERGLOW_RGB_MODE_FORWARD,
    UG_RGB_MR  = UNDERGLOW_RGB_MODE_REVERSE,
    UG_RGB_HI  = UNDERGLOW_RGB_HUE_INCREASE,
    UG_RGB_HD  = UNDERGLOW_RGB_HUE_DECREASE,
    UG_RGB_SI  = UNDERGLOW_RGB_SAT_INCREASE,
    UG_RGB_SD  = UNDERGLOW_RGB_SAT_DECREASE,
    UG_RGB_VI  = UNDERGLOW_RGB_VAL_INCREASE,
    UG_RGB_VD  = UNDERGLOW_RGB_VAL_DECREASE,
    UG_RGB_SPI = UNDERGLOW_RGB_SPEED_INCREASE,
    UG_RGB_SPD = UNDERGLOW_RGB_SPEED_DECREASE,
    DIAL_BUT   = RADIAL_BUTTON,
    DIAL_L     = RADIAL_LEFT,
    DIAL_R     = RADIAL_RIGHT,
    DIAL_LC    = RADIAL_LEFT_CONTINUE,
    DIAL_RC    = RADIAL_RIGHT_CONINUE,   
    RGB_INDTOG = RGB_IND_TOGGLE,
    RGB_INDMF  = RGB_IND_MODE_FORWARD,
    RGB_INDMR  = RGB_IND_MODE_REVERSE,
