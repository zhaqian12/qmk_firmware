...
#define SQ_T(n) (n < SEQUENCER_TRACKS ? SEQUENCER_TRACK_MIN + n : KC_NO)
    ...
    UNDERGLOW_RGB_HUE_INCREASE,
    UNDERGLOW_RGB_HUE_DECREASE,
    UNDERGLOW_RGB_SAT_INCREASE,
    UNDERGLOW_RGB_SAT_DECREASE,
    UNDERGLOW_RGB_VAL_INCREASE,
    UNDERGLOW_RGB_VAL_DECREASE,
    UNDERGLOW_RGB_SPEED_INCREASE,
    UNDERGLOW_RGB_SPEED_DECREASE,
...
#define ALT_TAB_F ALT_TAB_FORWARD
#define ALT_TAB_R ALT_TAB_REVERSE
...
#define UG_RGB_MS UNDERGLOW_RGB_MODE_SYNC
#define UG_RGB_MF UNDERGLOW_RGB_MODE_FORWARD
#define UG_RGB_MR UNDERGLOW_RGB_MODE_REVERSE
#define UG_RGB_HI UNDERGLOW_RGB_HUE_INCREASE
#define UG_RGB_HD UNDERGLOW_RGB_HUE_DECREASE
#define UG_RGB_SI UNDERGLOW_RGB_SAT_INCREASE
#define UG_RGB_SD UNDERGLOW_RGB_SAT_DECREASE
#define UG_RGB_VI UNDERGLOW_RGB_VAL_INCREASE
#define UG_RGB_VD UNDERGLOW_RGB_VAL_DECREASE
#define UG_RGB_SPI UNDERGLOW_RGB_SPEED_INCREASE
#define UG_RGB_SPD UNDERGLOW_RGB_SPEED_DECREASE
