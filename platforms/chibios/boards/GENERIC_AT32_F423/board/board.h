 ...
 * Board identifier.
 */
#define BOARD_AT32F423xx
#define BOARD_AT32F423
#define BOARD_NAME              "AT32F423"
 ...
 * PF8  - PIN7                      (input pullup).
 * PF9  - PIN8                      (input pullup).
...
#define VAL_GPIOF_MUXL              (PIN_MUX(GPIOF_PIN0, 0U) |              \
                                     ...
                                     PIN_MUX(GPIOF_PIN8, 0U) |              \
                                     PIN_MUX(GPIOF_PIN9, 0U))
#define VAL_GPIOF_MUXH              (PIN_MUX(GPIOF_PIN10, 0U))
