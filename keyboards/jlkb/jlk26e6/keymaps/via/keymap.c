...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_2, 
		KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_3, 
		KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_4, 
		KC_P1, KC_P2, KC_P3, KC_P4, KC_COMM, KC_DOT, KC_5, 
		KC_UP, KC_DOWN, KC_RGHT, KC_LEFT, KC_P5, KC_P6, KC_6, 
		KC_ENT, KC_7, KC_8, KC_9, KC_0, KC_A, KC_B),
...
if (clockwise) {
tap_code16(dynamic_keymap_get_keycode(biton32(layer_state), 6, 1));
} else {
tap_code16(dynamic_keymap_get_keycode(biton32(layer_state), 6, 2));
}
}if (index == 4) {
if (clockwise) {
tap_code16(dynamic_keymap_get_keycode(biton32(layer_state), 6, 3));
} else {
tap_code16(dynamic_keymap_get_keycode(biton32(layer_state), 6, 4));
}
}if (index == 5) {
if (clockwise) {
tap_code16(dynamic_keymap_get_keycode(biton32(layer_state), 6, 5));
} else {
...
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 1, HSV_AZURE}       // Light 4 LEDs, starting with LED 6
);
