...
#include "underglow_rgb_matrix_override.h"
#include "eeprom.h"
...
#define UNDERGLOW_RGB_MATRIX_STARTUP_HUE RGB_MATRIX_STARTUP_HUE
#endif

#if !defined(UNDERGLOW_RGB_MATRIX_STARTUP_SAT)
#define UNDERGLOW_RGB_MATRIX_STARTUP_SAT RGB_MATRIX_STARTUP_SAT
#endif
...
#define UNDERGLOW_RGB_MATRIX_STARTUP_SPD RGB_MATRIX_STARTUP_SPD
#endif
